  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center text-white">
      <form onSubmit={handleSubmit} className="bg-gray-800 p-8 rounded-lg w-96">
        ...
        {!isLogin && <input type="text" placeholder="Full Name - e.g. Suchitra Kodali" value={name} onChange={e=>setName(e.target.value)} className="w-full p-2 mb-4 rounded bg-gray-700" required minLength={2} />}
